#!/usr/bin/env python3
"""Convertir MANUAL_USUARIO.md a MANUAL_USUARIO.docx

Este script es una variante del convertidor de manual de instalación, adaptada
para generar el manual de usuario.

Uso:
    python tools/convert_manual_to_docx_user.py
...
MD_PATH = ROOT / 'MANUAL_USUARIO.md'
DOCX_PATH = ROOT / 'MANUAL_USUARIO.docx'
...
def make_doc():
    ...
    try:
        doc.core_properties.title = 'Manual de usuario — GRCU Manager'
    ...
    title = 'Manual de Usuario — GRCU Manager'
